...
// or use VARIANT environment variable for example like "make -e VARIANT=VARIANT_NUNCHUK". Select only one at a time.
  ...
  #define VARIANT_ADC
#define ADC_MODE THROTTLE_BRAKE
// Variant for control via ADC input 
...
#define BAT_LVL4                (330 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // Yellow:       no beep
...
#define BAT_DEAD                (285 * BAT_CELLS * BAT_CALIB_ADC) / BAT_CALIB_REAL_VOLTAGE    // All leds off: undervoltage poweroff. (while not driving) [V*100/cell]. In this case 3.37 V/cell
// ######################## END OF BATTERY ###############################
...
#define N_MOT_MAX       3500            // [rpm] Maximum motor speed limit
